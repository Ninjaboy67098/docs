...
<AccordionGroup>
  <Accordion title="Estimate Created" defaultOpen="false">
...
1. This lifecycle ensures no step is skipped and no revenue is lost.
...
<Card title="Core Concepts (Quotes vs Jobs vs Invoices)" icon="sparkles" cta="The Main Functionalites">
  
</Card>

<Card title="Quote Types & Pricing Logic" icon="sparkles" cta="How The Estimating Logic Works">
  
</Card>

<Card title="Job Statuses & Scheduling Rules" cta="General Stuff About Scheduling">
